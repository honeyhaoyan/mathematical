    ...
    def test(self):
        ...
        with torch.no_grad():
            for _, batch in enumerate(self.test_dataloader):
                ...
                if (i==0):
                    torchvision.io.write_png(high_res[0, ...].mul(255).byte(), "high_res.png")
                    torchvision.io.write_png(high_res_prediction[0, ...].mul(255).byte(), "high_prediction.png")
                    torchvision.io.write_png(low_res[0, ...].mul(255).byte(), "low_res.png")
